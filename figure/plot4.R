...
png("plot4.png")
par(mfcol = c(2,2))
plot(select.data$Date, select.data$Global_active_power, type = "o", pch = ".", cex = 0.1, ylab = "Global Active Power")
plot(select.data$Date, select.data$Sub_metering_1, type = "n", xlab = NULL, ylab = "Energy sub metering")
...
plot(select.data$Date, select.data$Voltage, type = "o", pch = ".", cex = 0.1, xlab = "datetime", ylab = "Voltage")
plot(select.data$Date, select.data$Global_reactive_power, type = "o", pch = ".", cex = 0.1, xlab = "datetime", ylab = "Global_reactive_power")
dev.off()